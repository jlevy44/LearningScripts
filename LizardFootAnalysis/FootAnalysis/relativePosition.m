...
for strideNumber=1:Foot.numStrides; 
    ...
    for frame=Foot.intervalFrame(strideNumber,1):Foot.intervalFrame(strideNumber,2)
        ...
        if (strcmp(segmentName,'front'))
            ...
            relpos(frame-Foot.intervalFrame(strideNumber,1)+1,:)=[relFR...
                (frame-Foot.intervalFrame(strideNumber,1)+1,:)*xf(frame,:)',...
...
Foot.StancePositions=Foot.foot_pos(1:size(Foot.foot_pos),:)*100;
