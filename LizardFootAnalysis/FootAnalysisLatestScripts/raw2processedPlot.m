function [ relFoot,trialID ] = raw2processedPlot( relFoot, stanceNumber )
...
%             end;
    ...
    %fix these trials
    disp('Please click on 2 outlier trial');
    ClickInput=ginput(2);
    [ trialID{j,1} ] = WhichTrial( ClickInput(1,:),relFoot,k, stanceNumber );
    [ trialID{j+1,1} ] = WhichTrial( ClickInput(2,:),relFoot,k, stanceNumber );
