function [ relfootdat, COMsegment, firstStancePositions ] = RelativeFootData( lizbuild )
...
for n=1:s(2) %all trials
    ...
    for i=1:4 
        ...
        if strcmp(B(n).feet(i).foottype,'HI') 
            ...
            firstStancePositions(n).HI=HI(n).firstStancePositions;
        end; 
        ...
        if strcmp(B(n).feet(i).foottype,'FO')
            ...
            firstStancePositions(n).FO=FO(n).firstStancePositions;
        end;
        ...
        if strcmp(B(n).feet(i).foottype,'FI')
            ...
            firstStancePositions(n).FI=FI(n).firstStancePositions;
        end;
        ...
        if strcmp(B(n).feet(i).foottype,'HO')
            ...
            firstStancePositions(n).HO=HO(n).firstStancePositions;
        end;
